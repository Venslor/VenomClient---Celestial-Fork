...
import net.pvproom.client.event.impl.AddonAddEvent
...
import net.pvproom.client.game.addon.FabricMod
import net.pvproom.client.game.addon.JavaAgent
import net.pvproom.client.game.addon.JavaAgent.Companion.add
import net.pvproom.client.game.addon.JavaAgent.Companion.migrate
import net.pvproom.client.game.addon.JavaAgent.Companion.setArgFor
import net.pvproom.client.game.addon.LunarCNMod
import net.pvproom.client.game.addon.WeaveMod
import net.pvproom.client.game.addon.WeaveMod.Companion.add
import net.pvproom.client.gui.GuiLauncher
import net.pvproom.client.gui.layouts.VerticalFlowLayout
import net.pvproom.client.utils.chooseFile
...
class GuiAddonManager : JPanel() {
    ...
    init {
        ...
        this.border = BorderFactory.createCompoundBorder(
            titledBorder,
            BorderFactory.createEmptyBorder(10, 15, 10, 15) // İç padding
        )
    ...
    private fun initGui() {
        ...
        /*panelCelePatch.add(f.getString("gui.addons.patch.drag").toJButton {
            chooseFile(FileNameExtensionFilter("Venom Patch", "jar"))?.let {
